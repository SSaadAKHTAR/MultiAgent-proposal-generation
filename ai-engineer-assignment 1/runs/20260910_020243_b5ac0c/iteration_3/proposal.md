...
*   **Success Criteria:** The engagement aims to achieve a 30% reduction in dispatch time per load, return the business to a five-day DSO, and ensure that 60–70% of the workflow logic built during Phase 1 remains portable to any future platform architecture. Finally, we understand the absolute necessity to launch a pilot into production by the end of Q3 to prevent the reallocation of project funding. The Q3 deadline is a hard financial constraint; pushing to Q4 means forfeiting the current funding.
...
*   **Phase 1C: Target Pilot Launch (End of Q3)**
    *   Release the initial workflow improvements into production by the end of Q3 to satisfy mandatory funding requirements. (We acknowledge the internal debate regarding engineering feasibility, but Q3 remains a hard deadline to retain the project budget).
...
For this 6-month Phase 1 scope, we will explicitly scale down the team size over the 6 months to ensure the total fixed-fee cost remains strictly under the $300,000 hard cap. Rather than billing time and materials, we will structure the final proposal as a hard fixed fee tied to the specific deliverables outlined in the Phases & Timeline section. We will finalize the exact pricing once we have resolved the open questions below.
